...
test('five original minutes add five distinct records with dates from their contents', async () => {
  ...
  assert.equal(audit.stats.recordsBefore + audit.stats.recordsAdded, records.length);
...
test('built public page exposes the 1599 total and all three reviewed 2010 events', async () => {
  ...
  assert.match(html, /Search all 1,599 records/);
