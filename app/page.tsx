...
const events: Event[] = [
  ...
  },
  {
    ...
    sources: [{
      ...
      format: "ZIP",
      role: "Primary source",
      result: "Three-table USGS export containing station metadata and ten approved field and channel measurements.",
      clock: {
        eventStamp: "2001-09-11 · time not stated",
        basis: "Latest field-measurement date in the supplied export",
        note: "The event summarizes the latest observation while preserving the full 1975–2001 discrete-measurement range in the finding.",
      },
    }],
  },
  {
