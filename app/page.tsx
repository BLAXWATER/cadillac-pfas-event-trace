...
const events: Event[] = [
  ...
  },
  {
    ...
    isoDate: "2014-08-29",
    time: noTime,
    timeBasis: "License issue date",
    phase: "Operating license",
    kind: "regulatory",
    category: "03 · Permits & records",
    title: "License 9405 preserves County and operator remedial-action duties",
    finding: "The 2014 Wexford landfill operating license states that County DPW responsibilities under the 2007 remedial-action agreement continue regardless of ownership transfer. It also requires owner/operator implementation and access for DPW and its contractors (p. 6). Page 3 records a separate $987,000 DPW remedial-action financial-assurance mechanism, alongside $8,441,567.82 in facility assurance against $8,385,937.20 required.",
    significance: "This provides a documentary link from the 2007 remedial-action agreement through private ownership, not evidence that the remedy was completed. Page 4 incorporates the July 2014 leachate recirculation plan and revised 2012 monitoring plan; page 5 lists permitted daily-cover materials and restrictions. Obtain those plans, the agreement and implementation/monitoring records to verify performance. The license contains no PFAS results or proof of individual deliveries. Its August 2019 stated expiration is historical, not a determination of current authorization.",
    sources: [archivedSource("DEQ-WHMD-WEXFORD_COUNTY_OpLicense_241193_7.pdf", "/wexford-docs/116-1406440ae1fc.pdf", 7, "Pages 3–6: financial assurance, incorporated plans, daily-cover restrictions and continuing remedial-action duties. Attachment A is the facility map. All pages inspected; faint map details remain unresolved. LLC/Inc. headers and differing RAP approval dates are retained as source discrepancies.", { eventStamp: "2014-08-29 · license issued", basis: "Signed license cover", note: "License 9405 supersedes 9366. Referenced plans and agreements are not reproduced in this seven-page file." })],
  },
  {
    year: "2014",
    date: "2014-10-10",
  ...
  },
  {
    ...
    isoDate: "2016-01-13",
    time: "Not stated",
    timeBasis: "Effective date in the signed certificate termination; cover letter issued January 25",
    phase: "Stormwater permit termination",
    kind: "regulatory",
    category: "12 · Wexford landfill & stormwater compliance",
    title: "DEQ terminates Wexford stormwater coverage after no-discharge inspection",
    finding: "Brian W. Jankowski's signed statement terminates NPDES stormwater certificate MIS111718 effective January 13, 2016, after a scheduled inspection determined that the site did not discharge stormwater. Jamie Wade transmitted the statement to Eddie Ascione on January 25. The handwritten record links a September 24, 2015 inspection to a December 2 follow-up about no-exposure/termination. A separate table lists historical enforcement ID 2177 as Terminated; its underlying order and grounds are absent.",
    significance: "This closes the documented stormwater-coverage sequence, not landfill operation, groundwater authorization or leachate deliveries. Industrial-stormwater surface discharge would require a new NPDES permit. Blank violation/complaint tables do not establish an entirely violation-free history. The underlying consent order and termination record remain a follow-up lead; this file does not establish their relationship to the stormwater decision, the January 12 WWTP spill, or March 2016 Citation 432.",
    sources: [{
      name: "2015-2016_Wexford County Landfill_District Compliance File.pdf",
      url: "/wexford-docs/001-7c991baaf1e9.pdf",
      pages: 8,
      page: 2,
      format: "PDF",
      role: "Primary source",
      result: "Pages 1–2: transmittal and signed termination. Pages 3–4: inspection/follow-up notes, with some handwriting unresolved. Page 5: terminated enforcement entry 2177. Pages 6–7: None for effluent violations, other tables blank. Page 8: signed September 24, 2015 pre-inspection report.",
      clock: {
        eventStamp: "2016-01-13 · time not stated",
        basis: "Termination effective date on page 2; January 25 cover letter on page 1",
        note: "PDF creation/modification metadata is April 17, 2025, not an event date. All eight scanned pages were freshly OCRed and visually reread on September 15, 2026. The repeated upload is byte-identical to the existing canonical original; unresolved handwriting is not treated as strictly verified text.",
      },
    }],
  },
  {
  ...
  },
  {
    ...
    date: "2018-02-19",
    isoDate: "2018-02-19",
    time: "6:00 PM · scheduled meeting",
    timeBasis: "Agenda date and time; not proof of Council action",
    phase: "Biosolids and preventive maintenance recommendations",
    kind: "regulatory",
    category: "05 / 10 · Biosolids & WWTP infrastructure",
    title: "Council packet recommends biosolids contract and preventive WWTP repairs",
    finding: <>The February 19 packet reports <strong>1.5–2.0 million gallons of biosolids applied annually</strong> and recommends Midwest Injection at <strong>$0.0440 per gallon</strong> through December 31, 2020. Its $66,000 figure assumes 1.5 million gallons; it is not an invoice or actual haul total. Separate recommendations cover the final-effluent-water pump, EQ basin, Muffin Monster, RAS spare and digester circulator. The $25,710 EQ-basin recommendation explicitly states <strong>the existing tank had not failed</strong>.</>,
    significance: "This connects the City's proposed biosolids service and preventive-maintenance spending to the later operations record. It does not establish an award, completion, PFAS clearance or Wexford leachate load. Obtain approved February 19 minutes, executed contracts, invoices and hauling records before closing those leads. The packet contains draft February 5 minutes, not February 19 approvals.",
    sources: [{...archivedSource("February 19 2018 City Council Packet.pdf", "https://github.com/BLAXWATER/cadillac-pfas-event-trace/blob/c2c8d7188811b026c9c2bd7b91301c387ae2b131/public/findings-docs/204-f9c021f6fa7a.pdf", 69, "PDF p55: four biosolids bids and recommended contract. Pages56–60: five WWTP equipment/repair recommendations; p57 states the EQ tank has not failed. All69 pages revisited with text/images/OCR; unrelated survey fine print remains partly unreadable and attached lake-study conflicts are retained.", {eventStamp:"2018-02-19 6:00 PM · scheduled meeting",basis:"Agenda and dated Council communications",created:"2018-02-15 15:36:02 -05:00",modified:"2018-02-15 15:36:02 -05:00",note:"Recommendations are not executed awards or completed operations. Reviewed with limitations, not Strict Fully Verified."}),page:55}],
  },
  {
    year: "2018",
    date: "2018-02-19",
    isoDate: "2018-02-19",
    time: noTime,
    timeBasis: "Council packet date; attached report January 2018, measurements in 2017",
    phase: "Lake report and follow-up sampling proposal",
    kind: "receptor",
    category: "13 · Watershed context",
    title: "Lake Cadillac report calls for storm-drain sampling and retains data conflicts",
    finding: <>The attached RLS report's tables show <strong>0.4 mg/L bottom dissolved oxygen at three Lake Cadillac basins on August 16, 2017</strong>. It recommends targeted storm-drain sampling before major lake treatments. The report also states some intended inflow samples could not be isolated because of mixing. Unresolved discrepancies include August chlorophyll-a values of 6.0 µg/L in tables versus 9–11 in the narrative, a 13.5-acre milfoil map label versus 23.5 in the narrative/history, and a macroinvertebrate total inconsistent with its rows.</>,
    significance: "Historical lake-quality observations and a proposed investigation—not PFAS results, a WWTP BOD test, proof of a permit violation, or an established landfill-to-lake/groundwater route. Request underlying lab sheets, treatment records and any subsequent storm-drain results. Preserve June/July and 2017/2018 date conflicts rather than treating all report values as reconciled.",
    sources: [{...archivedSource("February 19 2018 City Council Packet.pdf", "https://github.com/BLAXWATER/cadillac-pfas-event-trace/blob/c2c8d7188811b026c9c2bd7b91301c387ae2b131/public/findings-docs/204-f9c021f6fa7a.pdf",69,"RLS report PDF pp22–52: tables pp28–30; chlorophyll narrative p33; vegetation map p41 and history p42; inconsistent macroinvertebrate total p47; storm-drain sampling recommendation p50. Document dates and measurement dates remain separate.",{eventStamp:"2018-02-19 · packet; January 2018 report of 2017 work",basis:"Packet cover, report title and dated tables",created:"2018-02-15 15:36:02 -05:00",modified:"2018-02-15 15:36:02 -05:00",note:"Internal conflicts remain unresolved. No contamination source attribution is established."}),page:29}],
  },
  {
    year: "2018",
    date: "2018-02-20",
  ...
  },
  {
    ...
    date: "2018-05-21",
    isoDate: "2018-05-21",
    time: "18:00 scheduled",
    timeBasis: "Packet agenda; amendment adoption not established by unsigned resolution",
    phase: "Leachate revenue amendment proposal",
    kind: "operation",
    category: "12 · Landfill receiving and finance",
    title: "May packet proposes a $250,000 increase in leachate revenue",
    finding: "FY2018 Budget Amendment #3 proposes increasing the leachate line from $150,000 to $400,000, explicitly to recognize additional revenue from treatment of Wexford County Landfill leachate. Water and Sewer Fund revenue would rise from $4,144,000 to $4,394,000. A separate $60,000 legal-fee increase is attributed to annexation litigation, not leachate treatment costs.",
    significance: "A financial link in the landfill-to-WWTP receiving history. The resolution has blank votes and certification fields; this packet does not independently establish adoption or actual cash receipts. Do not merge this FY2018 amendment with the separate FY2019 adopted-budget event, convert dollars into gallons, or infer PFAS removal. Match approved minutes, ledger entries, invoices and receiving logs before closing those questions.",
    sources: [{
      ...archivedSource("May 21 2018 City Council Packet [Item 1047].pdf", "/findings-docs/045-25d3c10b9ea8.pdf", 166, "PDF p.157 (Exhibit A p.4): leachate increase and its stated purpose. PDF pp.152–153: unsigned amendment resolution; pp.154–156: remaining amendment schedules. All166 pages reread; original hash matched the existing canonical record.", {
        eventStamp: "2018-05-21 · 18:00 scheduled",
        basis: "Agenda and proposed amendment date",
        created: "2018-05-17 13:49:01 -04:00",
        modified: "2018-05-17 13:50:57 -04:00",
        note: "Preparation metadata predates the scheduled meeting. Blank approval fields remain explicit.",
      }), page: 157,
    }],
  },
  {
    ...
    isoDate: "2018-05-16",
    time: noTime,
    timeBasis: "Revision date printed on the two brownfield plans",
    phase: "Brownfield investigation and source-review limits",
    kind: "regulatory",
    category: "12 · Brownfield groundwater investigation context",
    title: "Ace and Raven brownfield plans preserve investigation leads and conflicting statements",
    finding: "The Ace plan reports a 1992 underground-tank release, investigation through1995, excavation and closure of the LUST listing. Its March2018 PhaseII summary describes five soil samples and one groundwater sample for petroleum-related organics and metals—not PFAS. The Raven plan reports low contamination risk, but calls the property both not a Part201 facility and a Part201 facility on the same page. The plans were included for proposed May21 Council action.",
    significance: "Obtain the underlying PhaseI/II reports, laboratory results, boring logs and1995 closure record before accepting the summaries as verified environmental outcomes. Ace's page57 says 'one none' concerning criteria exceedances and mixes cadmium/chromium wording; reported nondetects are not zero concentrations. Address, eligibility and tax-model inconsistencies remain unresolved. DDA April25 minutes report acceptance of interlocal agreements, not proof of completed remediation. No landfill-to-Ace/Raven/Plett pathway or PFAS source is established.",
    sources: [{
      ...archivedSource("May 21 2018 City Council Packet [Item 1047].pdf", "/findings-docs/045-25d3c10b9ea8.pdf", 166, "Raven pp.17–46, especially conflicting facility statements p.26 and affidavit p.46; Ace pp.47–79, especially investigation summary pp.56–57 and affidavit p.79. Proposed resolutions are unsigned. DDA minutes pp.164–166 separately report interlocal-agreement votes and consultant reimbursement structure. Underlying analytical reports are not attached.", {
        eventStamp: "2018-05-16 · revision date",
        basis: "Plan headers; March2018 is the reported investigation month, not this revision date",
        created: "2018-05-17 13:49:01 -04:00",
        modified: "2018-05-17 13:50:57 -04:00",
        note: "Every supplied page reviewed; source contradictions retained, not Strict Fully Verified.",
      }), page: 57,
    }],
  },
  {
    ...
    phase: "Demolition procurement proposal",
    kind: "operation",
    category: "12 · Waste-disposal procurement context",
    title: "Stimson demolition memo lists Northern A-1 as a bidder, not the selected contractor",
    finding: "For the fire-damaged structure at434 Stimson Street, staff reports quotes of $19,500 from Pitsch Companies and $24,900 from Northern A-1 for demolition of what the memo describes as an asbestos-containing building. Staff recommends waiving competitive bidding and contracting Pitsch, with a court hearing scheduled for May30 before authorization.",
    significance: "A bounded contractor-identity lead: Northern A-1 appears as a quoted bidder only. The memo does not prove Council approval, a court order, completed demolition, asbestos testing, a waste shipment or disposal at Wexford Landfill/Cadillac WWTP. Follow the executed contract, court order, asbestos survey and disposal manifests to establish any later handling chain.",
    sources: [{
      ...archivedSource("May 21 2018 City Council Packet [Item 1047].pdf", "/findings-docs/045-25d3c10b9ea8.pdf", 166, "PDF p.148: March9 fire, April11 condemnation, two quoted vendors, planned May30 hearing and recommendation for Pitsch. No underlying bid letters, asbestos analysis, court order or disposal documentation is attached.", {
        eventStamp: "2018-05-21 · memo date",
        basis: "Date printed on Council communication",
        created: "2018-05-17 13:49:01 -04:00",
        modified: "2018-05-17 13:50:57 -04:00",
        note: "The enclosing packet was prepared before the memo's agenda date; recommendation and subsequent events are distinct.",
      }), page: 148,
    }],
  },
  {
  ...
  },
  {
    ...
    isoDate: "1994-03-03",
    time: noTime,
    timeBasis: "Approval date written beside the signature on PDF page 10",
    phase: "Superfund remedy-area determination",
    kind: "receptor",
    category: "13 / 14 · Groundwater, wells & hydrogeology",
    title: "EPA includes North Park and West of Leeson in the cleanup",
    finding: "EPA's signed Explanation of Significant Differences concludes that contamination in North Park and West of Leeson is commingled with groundwater contamination at the Northernaire/Kysor site and requires both areas to be included in the remedial action (PDF pp9–10). The attached MDNR memorandum reports a TCE-contaminated zone more than 1,100 feet across in North Park and an unbroken contaminated profile more than 1,200 feet long across the West of Leeson study line (pp12–13).",
    significance: "This is a final remedy-area determination supported by 1992 sampling, not merely a proposal. Michigan agreed that both areas must be included but continued disputing the ROD's TCE cleanup levels. The record concerns historical VOC and hexavalent-chromium contamination; it does not test PFAS, map present conditions or establish a pathway to Plett Road.",
    sources: [archivedSource("EPA Explanation of Significant Differences — Northernaire Plating and Kysor.pdf", "/findings-docs/095-b7620af87938.pdf", 22, "All 22 pages reviewed. Signed determination pp9–10; June 11, 1993 MDNR memorandum pp12–13; laboratory and well-result tables pp14–22.", {
      eventStamp: "1994-03-03 · exact time not stated",
      basis: "Approval date written beside the signature on PDF page 10; EPA archive metadata identifies the same document date",
      note: "The supplied Kysor-234897.pdf is byte-identical to the already published source. It is retained as one canonical record, not duplicated.",
    })],
  },
  {
    year: "1983",
    ...
    isoDate: "1983",
    time: noTime,
    timeBasis: "Publication year cited for the Michigan DNR report; the work began July 25, 1983",
    phase: "Historical road-brine and groundwater review",
    kind: "receptor",
    category: "13 / 14 · Groundwater, wells & hydrogeology",
    title: "State review flags possible road-brine effects at Plett Road wells",
    finding: "Michigan DNR's Table II identifies seven residential or business wells on Plett Road in Section 34 of Haring Township among sites of water-well contamination “POSSIBLY ATTRIBUTABLE TO ROAD BRINING” (PDF p15, printed p12). The same table also lists the Depew residence on Colfax Street in Cadillac and the Forsgren residence on 41½ Road in Cedar Creek Township. The following page says these listed cases were sampled at no more than 550 mg/L chloride and reports no health effects to date.",
    significance: "This is a qualified 1983 chloride/road-brine finding, not PFAS evidence, proof of a current pathway, identification of the 1140 Plett Road receptor, or a finding about the WWTP. Table III's 11,947,110-gallon 1982 estimate is for the Cadillac Geological Survey District, not the City of Cadillac, and the report calls its statewide data estimated and conservative.",
    sources: [archivedSource("The Use of Oil Field Brine on Michigan Roadways.pdf", "/findings-docs/210-6aec96618242.pdf", 78, "All 78 supplied pages rendered, OCRed and visually reviewed. Wexford well table PDF p15; qualification p16; Cadillac District estimate p20; recommendations pp57–67; appendices, footnotes and bibliography pp60–78.", {
      eventStamp: "1983 · exact publication day/time not stated",
      basis: "Publication year in the Michigan source; July 25, 1983 is the stated project-start date, not treated as the issue date",
      note: "The table says possibly attributable. The record does not establish a PFAS source, a present-day condition, or a specific connection to 1140 Plett Road or the Cadillac WWTP.",
    })],
  },
  {
    year: "1983",
  ...
  },
  {
    ...
    isoDate: "1983-05-31",
    time: noTime,
    timeBasis: "Preparation footer; approval/date lines blank",
    phase: "Federal investigation funding request",
    kind: "receptor",
    category: "13 / 14 · Groundwater, wells & hydrogeology",
    title: "EPA requests Northernaire RI and FS funding before removal",
    finding: "The memorandum requests $300,000 for a 40-week remedial investigation and $150,000 for a 10-week feasibility study, proposed 100% EPA funding (PDF p2). It describes former plating operations on sandy ground southwest of the municipal well field and considers immediate removal, sewer disconnection and possible soil/floor decontamination. A cooperative agreement was anticipated June 17, 1983.",
    significance: "This is a request, not executed funding or spending. Approval lines are blank, some routing handwriting is unreadable and the stated Enforcement Release is absent. EPA 209451 separately documents July–August 1983 removal; the signed 1985 ROD records a later remedy decision. The sequence is administrative and historical, not a PFAS finding.",
    sources: [archivedSource("209480_Northernaire_RI_FS_Action_Memo.pdf", "/findings-docs/199-c1524e21ac46.pdf", 2, "Both pages inspected with images/OCR. Funding and blank approval fields p2; missing attachment referenced p1.", {
      eventStamp: "May 31, 1983 · preparation footer; time not stated",
      basis: "Typed footer, not June routing dates or anticipated agreement date",
      note: "Missing attachment and unreadable routing prevent blanket Strict Fully Verified status.",
    })],
  },
  {
    year: "1985",
    ...
    isoDate: "1985-09-11",
    time: noTime,
    timeBasis: "Signed EPA decision on PDF p5",
    phase: "Signed source-control remedy",
    kind: "receptor",
    category: "13 / 14 · Groundwater, wells & hydrogeology",
    title: "EPA signs Northernaire soil and sewer-sediment remedy",
    finding: "Valdas V. Adamkus signed the decision September 11, 1985 (PDF p5). The remedy calls for contaminated soil and sewer-sediment excavation, off-site disposal, limited building-floor modification and clean backfill (pp4,22), approximately $75,000 estimated. The groundwater investigation remains separate. Page 24 preserves the City's request for more extensive building/slab removal and the agencies' response, including unresolved adjacent-building sewer service.",
    significance: "Signed remedy selection is not completed construction or a disposal receipt. Planned 1986 work and candidate disposal facilities are not actual shipments. EP-leachate data concern laboratory extracts, not Wexford deliveries. A masked p9 footnote and degraded p15 table remain unresolved. The 120-page September1989 regional ROD listed in index 234881 is a different decision.",
    sources: [archivedSource("209538_Northernaire_Signed_Record_of_Decision.pdf", "/findings-docs/200-07119f8b3cdf.pdf", 24, "24 supplied pages inspected; signed date p5, selection pp4,22, City/agency responses p24; unresolved scan defects pp9,15.", {
      eventStamp: "September 11, 1985 · signed decision; time not stated",
      basis: "Signature page, not planned September 6 schedule entry",
      note: "Historical chromium/cadmium source-control approval; not PFAS analysis or completion certification.",
    })],
  },
  {
    year: "1987",
    ...
    isoDate: "1987-01",
    time: noTime,
    timeBasis: "Publication month; field work in 1985–1986",
    phase: "Supplemental groundwater investigation",
    kind: "receptor",
    category: "13 / 14 · Groundwater, wells & hydrogeology",
    title: "Northernaire well logs qualify sand and clay pathways",
    finding: "The supplemental RI describes well-sorted sandy aquifers with local gravel/silt, thin clay lenses and an upper clay unit that pinches out northward, where shallow and intermediate sands merge (PDF pp30–38). It interprets shallow flow northeast-to-north and intermediate flow generally northwest from historical heads (pp39–45). MW12/MW15 logs show sand/gravel interbeds within gross clay intervals, not uniformly solid clay (pp94–96,103–105). Authors could not positively identify the exact chromium transfer path or accurately assess potential municipal deep-aquifer impact (pp74–82).",
    significance: "Two further leads are reported tested purge-water infiltration at drilling locations (p24) and unidentified 'second phase product' in MW16 development water at 63–68 ft (p106). Neither establishes chemical identity, a Wexford source or a modern PFAS route. Map portions on pages 15/22 and an MW9 log continuation are missing; cropped cells, survey-elevation conflicts and analytical discrepancies remain explicit. All 118 supplied pages were inspected, but this is not Strict Fully Verified. Read alongside the later 1988 regional RI without merging datasets.",
    sources: [archivedSource("209637_Northernaire_Supplemental_Remedial_Investigation.pdf", "/findings-docs/201-962cc6781463.pdf", 118, "Geology pp30–46; tables pp48–73; uncertainty pp74–83; logs pp84–118. Purge water p24; unidentified product p106. All supplied pages revisited with images/OCR.", {
      eventStamp: "January 1987 · exact day/time not stated",
      basis: "Title-page month, not footer code 2.86.88",
      note: "Missing/corrupt details remain open. Historical chromium/VOC findings are not PFAS results or a source-to-Plett determination.",
    })],
  },
  {
    year: "2006",
    ...
    isoDate: "2006-07",
    time: noTime,
    timeBasis: "Issue month; June 20 dates draft RI/FS submissions",
    phase: "Landfill groundwater and interim actions",
    kind: "receptor",
    category: "12 / 14 · Landfill groundwater & hydrogeology",
    title: "Wexford fact sheet separates two plumes and interim groundwater treatment",
    finding: "The County's July 2006 fact sheet distinguishes a landfill-attributed west VOC plume from an east TCE plume of unknown source, and reports north-northwest groundwater movement of 280–360 ft/year (PDF p2). It describes a locally continuous clay aquitard 4 to over 30 ft thick, with limited investigation below it. Page 4 reports groundwater pumping since 1994, up to 750,000 gal/day through an onsite aeration pond and back to the aquifer. Waste relocation from unlined to lined cells began in 2005 and was expected to exceed 1.8 million cubic yards.",
    significance: "The pumping figure is not a leachate-delivery or WWTP-receiving total. Relocation volume is projected, not completed work. Pages 1, 3 discuss draft studies and estimated alternatives, not final RAP approval. These are historical landfill conditions, distinct from Northernaire's clay profile—not a proven PFAS route. The original was already cataloged; its old June 20 filename is preserved as an alias while the issue month is corrected to July 2006.",
    sources: [archivedSource("July 2006 — Wexford County Landfill Fact Sheet — 421579.pdf", "/wexford-docs/027-b6b5e1c0bddb.pdf", 4, "All4 pages freshly read, including cross-section, plume map, remedy comparison and schedule. Exact match to the existing421579 original.", {
      eventStamp: "July 2006 · exact day/time not stated",
      basis: "Printed issue heading, distinct from June 20 draft-study submissions",
      note: "County-reported historical findings; full RI/FS/RAP and future completion records not attached or independently verified here.",
    })],
  },
  {
    year: "1986",
  ...
  },
  {
    ...
    isoDate: "2009-09-08",
    time: noTime,
    timeBasis: "Meeting 6:00–10:29 p.m.; time of this vote not stated",
    phase: "Leachate service agreement",
    kind: "operation",
    category: "12 · Landfill & leachate",
    title: "Council approves Wexford leachate agreement as Miscellaneous File No. 842",
    finding: "The September 8, 2009 minutes record unanimous approval of motion 2009.216, moved by Spoelman and supported by Dyer, for Cadillac to accept and treat Wexford County Landfill leachate under Miscellaneous File No. 842. Interim City Manager Precia Garland described a July 1, 2009–June 30, 2011 term and limited changes; discussion describes a reduced sliding-scale rate based on pretreatment.",
    significance: "Direct evidence of Council approval, not the executed contract or proof that a load arrived on July 1. File 842 → executed agreement and rate schedule → receiving logs and invoices remains the verification chain. No numerical rate or pretreatment performance result is attached. The same meeting's municipal test-well votes are separate decisions, not evidence that leachate affected those wells.",
    sources: [{
      ...archivedSource("Miscellaneous File 842 — September 8 2009 Approval Minutes.pdf", "https://github.com/cazey43/cadillac-pfas-event-trace/blob/e792937dad5338952723a5b79b1a2f51f9ddae5e/public/findings-docs/008-5b67e1ed1d5c.pdf", 6, "Motion 2009.216 and the City Manager's term/rate description are on PDF p2. All six pages reread; these are approval minutes, not the executed agreement.", {
        eventStamp: "2009-09-08 · vote time unstated",
        basis: "Meeting opens 6:00 p.m. on p1 and adjourns 10:29 p.m. on p6; those are not the agreement vote time",
        note: "PDF creation/modification September 30, 2009 at 08:13:34 -04:00 is a later file clock, not the meeting or execution date. Typed closing names are not handwritten signatures.",
      }),
      page: 2,
    }],
  },
  {
    ...
    isoDate: "2009-09-08",
    time: noTime,
    timeBasis: "Meeting 6:00–10:29 p.m.; individual vote times not stated",
    phase: "Municipal well-field decisions",
    kind: "operation",
    category: "14 · Hydrogeology & mapping",
    title: "Council awards Blakely test-well bid but rejects other well-test spending",
    finding: "Following the recorded recusals of Stevens and Mayor Barnett, motion 2009.221 awards Ed Birkmeier Well Drilling LTD a $96,463 test-well drilling bid, 3–0. Motion 2009.223 separately extends the Fawcett option 60 days at no cost and changes its purchase amount from $50,000 to $45,000, 4–1. Motion 2009.224 requests a September 21 presentation on securing well-head properties, 4–1. Motion 2009.225 rejects $20,888 for a Boersma test well and $12,500 for a partial Fawcett test well plus $8,388 if a core sample is needed, 2–3. Garland says the hydrology consultant will return to discuss options.",
    significance: "Council authorization or denial → awarded contract → drilling logs and completion → laboratory and pumping-test data is the next-record chain. The minutes include competing DWRF eligibility statements and reported state testing approval, not the underlying agency letters or court orders. A bid award is not completed drilling; the rejected spending is not expenditure. Obtain the September 21 presentation, consultant records, permit letters and parcel/well identifiers. No PFAS result, measured flow direction or landfill-to-well pathway is established.",
    sources: [{
      ...archivedSource("September 8 2009 Special Meeting Minutes.pdf", "https://github.com/cazey43/cadillac-pfas-event-trace/blob/e792937dad5338952723a5b79b1a2f51f9ddae5e/public/findings-docs/008-5b67e1ed1d5c.pdf", 6, "PDF pp3–4: recusals and motion 2009.221. PDF p5: option extension, requested presentation and rejected motion 2009.225; all vote counts checked against the page image.", {
        eventStamp: "2009-09-08 · vote times unstated",
        basis: "Dated special-meeting minutes, not a drilling-completion or laboratory-report date",
        note: "Reported October 1 and October 15 data deadlines are retained as stated, not reconciled into one deadline. Boersma's name alone does not identify the parcel from the separate 2015 sewer-service litigation.",
      }),
      page: 4,
    }],
  },
  ...
  },
  {
    ...
    isoDate: "2026-08-07",
    time: noTime,
    timeBasis: "Daily sample date in the August DMR; measurement time not supplied",
    phase: "Reported DMR exceedance — qualification retained",
    kind: "compliance",
    category: "01 / 07 · DMR & compliance",
    title: "August DMR records CBOD5 above the printed daily limit",
    finding: "August 7 CBOD5 is reported as 12.70 mg/L versus a 10 mg/L maximum-daily limit (physical pages 1 and 11). The value-specific comment on page 9 states: ‘Debris in sample. Notified Aaron Kline.’ Patrick Miller submitted this August 1–31 report on September 17, 2026 at 6:30:48 AM (page 17).",
    significance: "The source documents a numeric exceedance and a reported notification, not a formal violation notice or SNC finding. No withdrawal, corrected result, underlying laboratory packet or agency disposition is attached. Summary No. Ex. cells are blank, not zero. Monthly CBOD5 and fecal-coliform summaries need reconciliation with the displayed daily values. PFOS is coded *g, not a measured result. These remain open verification leads.",
    sources: [archivedSource("MI0020257_2026-08-01_to_2026-08-31_DMR.pdf", "/dmr-docs/273-d116d6d3b972.pdf", 17, "Read all 17 physical pages: daily tables 1–9, template continuation 10, summaries 11–16, submission receipt 17. Relevant result pp. 1/11; qualification p. 9.", {
      eventStamp: "2026-08-07 · time not stated",
      basis: "Measurement date on daily table; September 17 submission is a separate record clock",
      note: "MiEnviro copy-of-record stamp: September 17, 2026 06:30:49 −04:00. Embedded CreationDate says 2016 and is not the sampling or submission date. Source reviewed; unresolved analytical and aggregation questions prevent blanket Fully Verified status.",
    })],
  },
  {
    year: "1977",
  ...
  },
  {
    ...
    significance: "Documents a March 18 budget-planning expectation, not the final load date, gallons, manifests, invoices or WWTP receiving-log entries. The April 1 packet repeats this material on pages 5–8 under DRAFT minutes; all four normalized text pages match the standalone work-session record. This is the same documentary statement, not independent corroboration or a second cessation event.",
    sources: [{
      ...
      name: "April 1 2019 City Council Packet [Item 1123].pdf",
      url: "/findings-docs/018-be4038bf5cd5.pdf",
      preview: bundledFirstPagePreview("/findings-docs/018-be4038bf5cd5.pdf"),
      pages: 49,
      page: 7,
      format: "PDF",
      role: "Enclosing packet / repeated source",
      result: "Page 7 repeats the leachate-revenue expectation in the attached March 18 work-session budget notes. Pages 6–7 also project the well-field cost and utility rates; forecasts are not actual expenditures or a PFAS-causation finding.",
      clock: {
        eventStamp: "2019-03-18 · approximately 16:20–17:34 work session; statement time not specified",
        basis: "Attached work-session date; enclosing packet scheduled for April 1, 2019",
        created: "2019-03-28 11:50:59 -04:00",
        modified: "2019-03-28 11:50:59 -04:00",
        note: "All 49 pages freshly reread September 14, 2026. Exact uploaded-file hash matches the existing Item 1123 record; the same original is reused. Draft and missing-record limitations remain explicit.",
      },
    }],
  },
  {
    ...
    isoDate: "2019-04-01",
    time: "18:00 scheduled",
    timeBasis: "Scheduled meeting on packet agenda, not evidence of adoption",
    phase: "Brownfield redevelopment proposal",
    kind: "regulatory",
    category: "12 · Supplemental municipal and brownfield records",
    title: "Lofts packet proposes brownfield hearing for the former Oleson block",
    finding: "The April 1 Council packet proposes an April 15 hearing for Cadillac Lofts at 201, 207 and 215 South Mitchell Street and 208 East Cass Street. The draft identifies environmental due diligence and due care, lead/asbestos abatement, demolition, site preparation and infrastructure as eligible activities. Its notice template describes an estimated $13m investment and 30-year brownfield term; a separate proposed commercial rehabilitation district has a 12-year term.",
    significance: "Connects the former Oleson-block redevelopment request in the February 2018 packet to later brownfield-hearing proposals. The 2019 drafts have blank resolution, voting and signature fields, an April 1, 2018 date within a 2019 packet, and a separate March 18 certificate date. Obtain approved minutes, the full brownfield plan and executed notices before asserting adoption; investigations, abatement and disposal records are needed before asserting completed cleanup. No PFAS source, pathway or violation is established.",
    sources: [{
      name: "April 1 2019 City Council Packet [Item 1123].pdf",
      url: "/findings-docs/018-be4038bf5cd5.pdf",
      preview: bundledFirstPagePreview("/findings-docs/018-be4038bf5cd5.pdf"),
      ...
      page: 29,
      format: "PDF",
      role: "Primary proposal record",
      result: "Pages 29–31: proposed brownfield resolution and notice; pages 32–37: proposed commercial district and parcel exhibits. The full brownfield plan is referenced but not attached. The draft reports CBRA recommendation on March 18; it does not supply those Authority minutes.",
      clock: {
        eventStamp: "2019-04-01 · 18:00 scheduled",
        basis: "Packet cover and agenda, retaining conflicting dates inside draft attachments",
        created: "2019-03-28 11:50:59 -04:00",
        modified: "2019-03-28 11:50:59 -04:00",
        note: "April 15 is the proposed hearing date, not verified here as a hearing that occurred. April 2 appears on the notice template; unsigned templates are not proof of mailing or publication.",
      },
    }, {
      ...archivedSource("May 21 2018 City Council Packet [Item 1047].pdf", "/findings-docs/045-25d3c10b9ea8.pdf", 166, "Intermediate project-history link: pp.9–10, attached DRAFT April16 minutes, report unanimous application authorization (2018-093), preliminary MDEQ grant $223,000 and loan $543,140, and a future reimbursement agreement. Pages80–87 contain unsigned May21 Lofts rezoning/sketch-plan templates. Neither is a final grant award, disbursement or cleanup-completion record.", {
        eventStamp: "2018-04-16 · reported in draft minutes",
        basis: "Date of enclosed minutes, distinct from May21 packet date",
        created: "2018-05-17 13:49:01 -04:00",
        modified: "2018-05-17 13:50:57 -04:00",
        note: "Connects February2018 planning to April2019 brownfield proposals; does not establish an unchanged project scope or completed remediation.",
      }),
      page: 9,
      role: "Intermediate project-history context",
    }, {
      name: "February 19 2018 City Council Packet.pdf",
      url: "/findings-docs/204-f9c021f6fa7a.pdf",
      preview: bundledFirstPagePreview("/findings-docs/204-f9c021f6fa7a.pdf"),
      pages: 69,
      page: 65,
      format: "PDF",
      role: "Earlier project-history context",
      result: "Pages 65–69 preserve the Oleson-block MPUD minimum-acreage waiver request and exhibits. This is a planning-history tie-back, not proof that the waiver was granted or a contamination connection.",
      clock: {
        eventStamp: "2018-02-19 · 18:00 scheduled",
        basis: "Earlier Council packet date",
        note: "Earlier survey fine print remains partly unreadable. No exact boundary, ownership continuity or migration pathway is inferred from map proximity.",
      },
    }],
  },
  {
