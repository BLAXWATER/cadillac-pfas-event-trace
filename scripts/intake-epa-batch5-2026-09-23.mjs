...
for (const record of records) {
  ...
  provenance[`/findings-docs/${record.id}.pdf`] = { sourceSha256: record.sha256, page: 1, preview, previewSha256: previewHashes[record.id], verifiedAt: reviewedAt, verificationMethod: "Actual first PDF page rendered during complete page-order review; full page preserved.", scope: "Preview provenance only; whole-document verification is recorded in the Batch 5 intake audit." };
...
const audit = {
  auditVersion: 1, intake: "EPA DOCS six-micro-batch intake", batch: "EPA-2026-09-23-B5", batchNumber: 5, totalBatches: 6, sourceOrderPreserved: true, reviewedAt, sourceAssetCommit: assetCommit, sourceAssetBranch: "epa-intake-batch-5", publishedAt: "2026-09-23T22:25:21.347322Z", publishedVersion: 322, deploymentId: "appgdep_6ab451c2f9c0819193709f424f938832", liveUrl: "https://cadillac-pfas-event-trace.icons-7120.chatgpt.site",
  ...
  records: [
    ...
    { supplied: "EPA_05_234886.pdf", sha256: records[2].sha256, bytes: 143612, pages: 3, ocrCheckedPages: [], disposition: "new-distinct-index-entry-5", canonicalRecordId: records[2].id, statuses: { received: true, extracted: true, reviewed: true, verified: "qualified", published: true } },
    ...
    { supplied: "EPA_05_234890.pdf", sha256: records[6].sha256, bytes: 56059, pages: 1, ocrCheckedPages: [], disposition: "new-distinct-september-1989-mdnr-comments", canonicalRecordId: records[6].id, missingReferencedRecords: ["ROD", "RI/FS"], statuses: { received: true, extracted: true, reviewed: true, verified: "qualified", published: true } }
  ],
